...
use halo2_proofs::poly::kzg::commitment::{ParamsKZG, KZGCommitmentScheme};
use halo2_proofs::poly::kzg::multiopen::{ProverGWC, VerifierGWC};
use halo2_proofs::poly::{commitment::ParamsProver, Rotation};
use halo2_proofs::poly::kzg::strategy::SingleStrategy;
use halo2_proofs::transcript::{Blake2bWrite, Blake2bRead, Challenge255, TranscriptWriterBuffer, TranscriptReadBuffer};
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    let mut keygen_group = c.benchmark_group("plonk-keygen-kzg");
    ...
    let mut prover_group = c.benchmark_group("plonk-prover-kzg");
    ...
    let mut verifier_group = c.benchmark_group("plonk-verifier-kzg");
    for k in k_range {
        let (params, pk) = keygen(k);
