...
impl<T> DeviceMemory<T> {
    ...
    pub fn memcpy_from_raw(&self, src: CUdeviceptr, size: usize) -> CudaResult<()> {
        ...
        let result = unsafe { cuMemcpy(self.inner, src, size_in_bytes) };
    ...
    pub fn memset_async(
        ...
        let result = unsafe { cuMemsetD32Async(self.inner, value, size_in_u32 , stream.get_inner()) };
    ...
    pub fn memcpy_from_to(
        ...
        let size_in_bytes = n * std::mem::size_of::<T>();
